...
public class TesteMetodosCollections {
	public static void main(String[] args) {
		...
		System.out.println("*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*--*-*--*-*-");
		System.out.println("--- Utilizando o método reverse: --- ");
		...
		System.out.println("*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*--*-*--*-*-");
		System.out.println("--- Utilizando o método shuffle: --- ");
		...
		System.out.println("*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*--*-*--*-*-");
		System.out.println("-- Utilizando o método rotate: rotacionar 5 posicoes -- ");
