...
public class TesteLambda {
	...
	public static void main(String[] args) {
		...
		// Lambda: Comparando  uma conta com a outra e ordenando de acordo com numero
		...
		//  Lambda Comparando  uma conta com a outra e ordenando de acordo com o nome
		...
		lista.sort(comp);
		lista.forEach(( conta) -> 	System.out.println(conta + " - " + conta.getTitullar().getNome()));
	}
}